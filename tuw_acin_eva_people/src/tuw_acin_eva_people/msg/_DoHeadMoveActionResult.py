"""autogenerated by genpy from tuw_acin_eva_people/DoHeadMoveActionResult.msg. Do not edit."""
import sys
...
class DoHeadMoveActionResult(genpy.Message):
  _md5sum = "675b99d7de51cb0d7a1e417c16e34298"
  _type = "tuw_acin_eva_people/DoHeadMoveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tuw_acin_eva_people/DoHeadMoveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoHeadMoveActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tuw_acin_eva_people.msg.DoHeadMoveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tuw_acin_eva_people.msg.DoHeadMoveResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.result.pos_reached))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.pos_reached,) = _struct_B.unpack(str[start:end])
      self.result.pos_reached = bool(self.result.pos_reached)
      return self
